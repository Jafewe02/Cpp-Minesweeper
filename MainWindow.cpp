...
void MainWindow::createActions() {
  ...
  leftAlignAct = new QAction(QIcon::fromTheme("format-justify-left"),
                            tr("&Left Align"), this);
  ...
  rightAlignAct = new QAction(QIcon::fromTheme("format-justify-right"),
                             tr("&Right Align"), this);
  ...
  justifyAct = new QAction(QIcon::fromTheme("format-justify-fill"),
                           tr("&Justify"), this);
  ...
  centerAct = new QAction(QIcon::fromTheme("format-justify-center"),
                          tr("&Center"), this);
